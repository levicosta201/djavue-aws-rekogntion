"""
Django settings for passangers-rekognition project.
...
ROOT_URLCONF = 'passangers-rekognition.urls'
...
WSGI_APPLICATION = 'passangers-rekognition.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './passangers-rekognition.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {

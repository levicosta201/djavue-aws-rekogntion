...
function devhelp {
    ...
    echo -e ""
    echo -e "${GREEN}dkawsinstall${RESTORE}         Get and install ${RED}aws CLI${RESTORE}"
    echo -e ""
    echo -e "${GREEN}dkawsconfigure${RESTORE}        Configure ${RED}aws CLI${RESTORE}"
    echo -e ""
}
